...
from accounts.decorators import unauthenticated_user, seller_only, allowed_users
from accounts.forms import CreateUserForm
from marketing.forms import OrderForm, SellProduct
from marketing.models import Order, PostProduct
...
def dashboard(request):
    ...
    delivered = orders_filter.filter(status_order='Delivered').count()
    pending = orders_filter.filter(status_order='Pending').count()
...
def sell_product(request):
    ...
    return render(request, 'accounts/sell_product.html', context)
